...
const ProductDetails = () => {
  ...
  const products = {
    '1': {
      ...
      description: 'A premium black hoodie that embodies the KENZAR philosophy of psychological comfort meets sophisticated design. Crafted from high-quality cotton blend for ultimate comfort and durability.',
      arabicDescription: 'هودي أسود فاخر يجسد فلسفة كنزار في الراحة النفسية مع التصميم المتطور. مصنوع من خليط قطني عالي الجودة للراحة القصوى والمتانة.',
      features: [
    ...
    '2': {
      ...
      price: 'Contact for Price',
      arabicPrice: 'تواصل للسعر',
      description: 'Minimalist elegance in our signature dark olive. This premium t-shirt represents the essence of KENZAR - simple yet meaningful, comfortable yet distinctive.',
      arabicDescription: 'أناقة بسيطة بلونا الزيتي المميز. هذا التيشيرت الفاخر يمثل جوهر كنزار - بسيط لكن ذو معنى، مريح لكن مميز.',
      features: [
    ...
    '3': {
      ...
      description: 'The "Stillness" jacket from KENZAR is more than just a piece of clothing; it is an expression of balance, strength, and inner calm. It combines classic black with modern gray in a clean design and elegant construction. It is meticulously crafted to deliver comfort and distinction in every detail.',
      arabicDescription: 'جاكيت "ستيلنيس" من كنزار هو أكثر من مجرد قطعة ملابس؛ إنه تعبير عن التوازن والقوة والهدوء الداخلي. يجمع بين الأسود الكلاسيكي والرمادي العصري في تصميم نظيف وبناء أنيق. مصنوع بعناية فائقة لتوفير الراحة والتميز في كل التفاصيل.',
      features: [
      ...
      sizes: ['S', 'M', 'L', 'XL'],
      images: ['/lovable-uploads/60e9aca1-2fd3-42ac-a4ba-7c3d23f8ad7e.png', '/lovable-uploads/fc765835-491a-4c73-8d9b-0a0e4076dfe0.png', '/lovable-uploads/9d283626-a700-425b-a80a-088060c33c6b.png', '/lovable-uploads/6c3b70db-0d59-4955-8138-e5484ec7e62c.png'],
      inStock: true,
      rating: 4.9,
      reviews: 156,
      ...
      <>
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center">
            <h1 className="font-cinzel text-4xl font-bold text-primary mb-4">Product Not Found</h1>
            <Link href="/collection" className="text-secondary hover:text-secondary/80 underline">
              Back to Collection
            </Link>
          </div>
        </div>
  ...
  const handleWhatsAppOrder = () => {
    ...
    const message = encodeURIComponent(`Hi! I'm interested in ordering the ${productName}${size} from KENZAR. Can you help me with details and pricing?`);
  ...
  const currentDescription = isRTL ? product.arabicDescription : product.description;
    ...
    <>
      ...
      <section className="py-8 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className={`flex items-center space-x-2 text-sm font-inter ${isRTL ? 'rtl:space-x-reverse' : 'ltr:space-x-reverse'}`}>
            <Link href="/" className="text-muted-foreground hover:text-primary transition-quick">
              {t('home')}
            </Link>
            <span className="text-muted-foreground">/</span>
            <Link href="/collection" className="text-muted-foreground hover:text-primary transition-quick">
              {t('collection')}
            </Link>
            <span className="text-muted-foreground">/</span>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className={isRTL ? 'lg:order-2' : ''}>
              <div className="sticky top-24">
                ...
                {/* Image Thumbnails */}
                <div className={`flex space-x-4 ${isRTL ? 'rtl:space-x-reverse' : 'ltr:space-x-reverse'}`}>
            ...
            <div className={isRTL ? 'lg:order-1' : ''}>
              ...
              <div className="mb-8">
                ...
                >
                  <ArrowLeft className={`w-4 h-4 mr-2 ${isRTL ? 'rtl-flip' : ''}`} />
                  Back to Collection
                </Link>
                ...
                <div className={`flex items-center space-x-4 mb-6 ${isRTL ? 'rtl:space-x-reverse' : 'ltr:space-x-reverse'}`}>
                  <div className={`flex items-center space-x-1 ${isRTL ? 'rtl:space-x-reverse' : 'ltr:space-x-reverse'}`}>
                    {[...Array(5)].map((_, i) => (
                      <Star 
                        key={i} 
                        className={`w-4 h-4 ${i < Math.floor(product.rating) ? 'text-yellow-500 fill-current' : 'text-muted-foreground'}`} 
                      />
                    ))}
                  ...
                  <div className={`flex items-center space-x-2 ${isRTL ? 'rtl:space-x-reverse' : 'ltr:space-x-reverse'}`}>
                    <Button
                      variant="ghost"
                      size="sm"
              ...
              <div className="grid grid-cols-3 gap-4 mt-8">
                <Card className="shadow-soft border-0">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="text-xs text-muted-foreground font-inter">Free Shipping</p>
                  </CardContent>
                </Card>
                <Card className="shadow-soft border-0">
                  <CardContent className="p-4 text-center">
                    <Shield className="w-6 h-6 text-secondary mx-auto mb-2" />
                    <p className="text-xs text-muted-foreground font-inter">Quality Guarantee</p>
                  </CardContent>
                </Card>
                <Card className="shadow-soft border-0">
                  <CardContent className="p-4 text-center">
                    <MessageCircle className="w-6 h-6 text-secondary mx-auto mb-2" />
                    <p className="text-xs text-muted-foreground font-inter">24/7 Support</p>
                  </CardContent>
                </Card>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {Object.values(products)
              ...
              .slice(0, 3)
              .map((relatedProduct) => (
              <Card key={relatedProduct.id} className="group shadow-soft hover:shadow-elegant transition-elegant border-0">
                <CardContent className="p-0">
                  <Link href={`/product/${relatedProduct.id}`}>
                    <div className="aspect-[3/4] bg-muted relative overflow-hidden">
                      <Image 
                        src={relatedProduct.images[0]} 
                        alt={isRTL ? relatedProduct.arabicName : relatedProduct.name}
                    ...
                    <div className="p-6">
                      <div className="text-sm text-secondary font-medium mb-2 font-inter">
                        {isRTL ? relatedProduct.arabicCategory : relatedProduct.category}
                      </div>
                      <h3 className="font-cinzel text-xl font-semibold text-primary mb-2">
                        {isRTL ? relatedProduct.arabicName : relatedProduct.name}
                      </h3>
                      <p className="text-muted-foreground font-inter">
                        {isRTL ? relatedProduct.arabicPrice : relatedProduct.price}
                      </p>
                    </div>
                  </Link>
                </CardContent>
